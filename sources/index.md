...
This file tracks all official and authoritative sources used across the Invest Gate KSA repository.

> Only add sources that are official government bodies, internationally recognized institutions, or verifiable public records. Do not add consulting firm marketing materials or unverified commentary.
...
| Organization | Role | Website |
|---|---|---|
| World Bank — Doing Business | Comparative ease-of-doing-business data | worldbank.org |
| OECD | FDI restrictiveness index | oecd.org |
| IMF | Economic and fiscal data | imf.org |
| UNCTAD | Foreign direct investment statistics | unctad.org |
...
2. In your document, cite the source inline using: `[Source: Organization Name](URL)`.
3. Note the access date in your document frontmatter.
